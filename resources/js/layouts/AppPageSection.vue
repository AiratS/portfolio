...
.app-page-section {
  ...
  .app-page-section__background {
    ...
    color: white;
    -webkit-text-stroke: 1px $app-grey;
  }

  .app-page-section__main {
    position: relative;
    z-index: 2;
    padding-left: 15px;
    padding-right: 15px;
